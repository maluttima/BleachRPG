...
// Find the start of FichaView and end before AdminPanel
...
if (idxStart === -1 || idxEnd === -1) {
  console.error("Could not find start or end markers for FichaView");
  process.exit(1);
}

const cleanFichaViewCode = `// TAB: FICHA DO JOGADOR
...
content = content.slice(0, idxStart) + cleanFichaViewCode + content.slice(idxEnd);
fs.writeFileSync('generate_app.js', content);
console.log("Successfully rebuilt FichaView cleanly into generate_app.js!");
