...
console.log("Writing full clean application generator...");

// Let's create the master generate_app.js file
const masterGeneratorCode = `const fs = require('fs');
...
fs.writeFileSync('generate_master.js', masterGeneratorCode);
console.log("generate_master.js created!");
