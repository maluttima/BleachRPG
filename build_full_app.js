...
console.log("Creating modular build_full_app.js...");

// We'll write out the comprehensive generate_app.js script
const generateAppScript = `const fs = require('fs');
...
\${fs.readFileSync('spiritual_engine.js', 'utf8').replace(/module\\.exports\\s*=[\\s\\S]*$/, '')}

// Helper: Power Tier Calculator
  ...
  personagens: [
    {
      ...
      personalidade: {
        texto: "Guerreiro analítico e leal. Prefere combater com velocidade e inteligência tática, mas arrisca a própria vida para proteger seus companheiros.",
...
fs.writeFileSync('app_source_head.jsx', appJsx);
console.log("Written app_source_head.jsx!");
`;

fs.writeFileSync('make_head.js', generateAppScript);
console.log("make_head.js written!");
