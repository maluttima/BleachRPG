...
console.log("Writing build_merged_app.js...");
...
// Extract part 1 (modals)
const modalsCode = fs.readFileSync('templates_builder.js', 'utf8');

// Extract part 2 (views 1)
const views1Code = fs.readFileSync('templates_part1_builder.js', 'utf8');

// Extract part 3 (views 2 - FichaView)
const views2Code = fs.readFileSync('templates_part2_builder.js', 'utf8');

// Extract part 4 (views 3 - AdminPanel, Sistemas, Root)
const views3Code = fs.readFileSync('templates_part3_builder.js', 'utf8');
...
fs.writeFileSync('app_source.jsx', finalAppSource);
console.log("Written full unified app_source.jsx!");
`;

fs.writeFileSync('build_merged_app.js', CodeContent);
console.log("build_merged_app.js written!");
